"""
Method 1: Raw Cosine Similarity
================================
Direct spectral matching using normalized cosine similarity
"""
...
def raw_features(spectrum):
    """Extract raw normalized spectrum features"""
...
def predict_raw_cosine(query_xs, query_ys, dataset, target_x):
    """
    Predict using raw cosine similarity
    ...
    query_features = raw_features(query_resampled)
    ...
    for idx, item in enumerate(dataset):
        ...
        features = raw_features(item_resampled)
...
if __name__ == "__main__":
    ...
    if len(dataset) > 0:
        ...
        result = predict_raw_cosine(query_xs, query_ys, dataset, target_x)
        
        print("="*60)
        print("RAW COSINE SIMILARITY METHOD")
        print("="*60)
